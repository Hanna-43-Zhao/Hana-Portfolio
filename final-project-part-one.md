...
# Outline
For my final project, I will use public data from the U.S. National Park Service (NPS) to analyze visitation trends across the national park system. Specifically, I want to explore patterns in visitor attendance, geographic distribution, and accessibility. My interest lies in uncovering how the popularity of different parks reflects broader aspects of American culture, geography, and infrastructure. By comparing highly visited destinations with lesser-known sites, I aim to highlight both the diversity of the park system and the behaviors of those who visit it. Also, A key part of the story will also focus on the disruption caused by the COVID-19 pandemic, adds an important example of how external events can reshape visitation patterns and public interaction with national parks.
...
For this project, I will use Tableau to create interactive visualizations such as line charts, maps, and heatmaps to highlight visitation trends over time, geography, and seasonality. These visualizations will then be integrated into a narrative webpage using Shorthand, combining text and visuals into a cohesive story. In addition, I plan to generate a word cloud using Brandwatch data to show how people talk about national parks online. The final product will be a publicly accessible digital project that allows the audience to follow the storyline while also exploring the data interactively.
